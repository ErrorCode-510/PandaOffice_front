...
function EmplPayroll() {
    ...
    // Fixed payment date as the 25th of the selected month
    const fixedPaymentDate = new Date(date.getFullYear(), date.getMonth(), 26); //25일 고정

    // Format the selected year and month for display without the day
        ...
        <>
            <div className="common-comp">
                ...
                <div className="search-section">
                    ...
                    />
                    <span style={{ marginLeft: "40px" }}>지급구분</span>
                    ...
                    <input
                        type="date"
                        value={fixedPaymentDate.toISOString().split('T')[0]}
                        disabled
                    />
                ...
                <div className="emplPay-table-combine">
                    ...
                    <div className="emplPay-table-container">
                        <table id="emplPay-data-table" className="emplPay-data-table">
                            <thead>
                                <tr>
                                    <th>코드</th>
                                    <th>이름</th>
