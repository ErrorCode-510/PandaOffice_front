...
function EmplPayroll() {
    ...
    const employees = payroll;                      // 사원
    const e_category = earningCategories;           // 지급 항목
    const d_category = deductionCategories;         // 공제 항목
