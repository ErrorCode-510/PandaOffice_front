...
const SET_REGIST_CALENDAR = 'schedule/SET_REGIST_CALEND';

/* 액션 생성 함수 */
export const { schedule: { getScheduleStatus, getInterviewer, getInterviewerId, getApplicantList, getCalendar, setRegistCalendar }} = createActions({
    ...
    [SET_REGIST_CALENDAR]: data => ({ registCalendar: data })
})
...
const interviewScheduleReducer = handleActions({
    ...
    [SET_REGIST_CALENDAR]: (state, { payload }) => {
